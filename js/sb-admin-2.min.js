...
! function (t) {
	...
	t("#sidebarToggle, #sidebarToggleTop").on("click", function (o) {
		t("body").toggleClass("sidebar-toggled"), t(".sidebar").toggleClass("toggled"),t(".maincontent").toggleClass("maincontent-toggled"),t(".fixedtopbar").toggleClass("fixedtopbartoggled"),t(".sidebar").hasClass("toggled") && t(".sidebar .collapse").collapse("hide")
